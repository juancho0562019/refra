...
const FilterModalDate = ({
  FilterModalDateSharedValueOne,
  FilterModalDateSharedValueTwo,
  ...
  const FilterModalDateContainerAnimatedStyle = useAnimatedStyle(() => {
    return {
      opacity: interpolate(
        FilterModalDateSharedValueOne.value,
        [SIZES.height, 0],
        [0, 1]
      ),
      transform: [
        {
          translateY: FilterModalDateSharedValueOne.value,
        },
      ],
    };
  });

  const FilterModalDateBgAnimatedStyle = useAnimatedStyle(() => {
    return {
      opacity: interpolate(
        FilterModalDateSharedValueTwo.value,
        [SIZES.height, 0],
        [0, 1]
      ),
    };
  ...
  const FilterModalDateContentAnimatedStyle = useAnimatedStyle(() => {
    return {
      opacity: interpolate(
        FilterModalDateSharedValueTwo.value,
        [SIZES.height, 0],
      ...
      transform: [
        {
          translateY: FilterModalDateSharedValueTwo.value,
        },
      ],
    };
  });
  ...
  return (
    <Animated.View
      style={[
        ...
        FilterModalDateContainerAnimatedStyle,
      ]}
    >
      ...
      <Animated.View
        style={[
          ...
          FilterModalDateBgAnimatedStyle,
        ]}
      >
        {/* Content Container */}
        <Animated.View
          style={[
            ...
            FilterModalDateContentAnimatedStyle,
          ]}
        >
          {/* Header */}
          <View
          ...
          >
            ...
            <TextButton
              ...
              onPress={() => {
                FilterModalDateSharedValueTwo.value = withTiming(SIZES.height, {
                  duration: 500,
                });

                FilterModalDateSharedValueOne.value = withDelay(
                  500,
...
export default FilterModalDate;
